 ...
 * @see org.streamingalgorithms.randomcutforest.RandomCutForest
 */
public interface ConvergingAccumulator<R> {
    ...
    enum CriticalDirection {
        HIGH, // We care about high values (positive deviations)
        LOW, // We care about low values (negative deviations)
        BOTH // We care about any large deviation (two-sided)
    }
}
