...
```text
$ java -cp core/target/randomcutforest-core-5.1.0.jar org.streamingalgorithms.randomcutforest.runner.AnomalyScoreRunner < example_input.csv > example_output.csv
...
```text
% java -jar benchmark/target/randomcutforest-benchmark-5.1.0-jar-with-dependencies.jar
```
