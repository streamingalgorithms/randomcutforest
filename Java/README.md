...
three-dimensional data shown in Figure 3.
...
```text
$ java -cp core/target/randomcutforest-core-5.0.0.jar org.streamingalgorithms.randomcutforest.runner.AnomalyScoreRunner < example_input.csv > example_output.csv
...
```text
$ java -cp core/target/randomcutforest-core-<version>.jar org.streamingalgorithms.randomcutforest.runner.AnomalyScoreRunner --help
Usage: java -cp target/random-cut-forest-<version>.jar org.streamingalgorithms.randomcutforest.runner.AnomalyScoreRunner [options] < input_file > output_file
...
Our tests are implemented in [JUnit 5](https://junit.org/junit5/) with [Mockito](https://site.mockito.org/), and [Hamcrest](http://hamcrest.org/) for testing. 
...
```text
% java -jar benchmark/target/randomcutforest-benchmark-5.0.0-jar-with-dependencies.jar
```
